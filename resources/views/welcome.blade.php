                        ...
                        @if (Route::has('login'))
                            <nav class="-mx-3 flex flex-1 justify-center lg:justify-end">
                                ...
                                @else
                                    <a
                                        href="{{ route('login') }}"
                                        class="mr-4 mt-2 inline-flex items-center px-4 py-2 bg-gray-800 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-gray-700 focus:bg-gray-700 active:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition ease-in-out duration-150"
                                        style="background-color: #66a4a3;"
                                    >
                                        Log in
                                    </a>
                    ...
                    <main class="mt-6 md:w-1/2 mx-auto">
                        <div class="flex">
                            ...
                            <div class="w-32 flex-auto">
                                <img src="/images/landing-page-photo.png" alt="Weight Watcher" />
                            </div>
                          </div>
                    </main>

                    <footer class="py-16 text-center text-sm text-black dark:text-white/70">
                        Weight Watcher &copy {{ date('Y') }}
                    </footer>
                </div>
            </div>
        </div>
